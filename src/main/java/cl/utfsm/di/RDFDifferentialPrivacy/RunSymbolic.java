                ...
                if (element instanceof ElementPathBlock)
                {
                    ...
                    while (bgpIt.hasNext())
                    {
                        ...
                        if (i == 0 && bgpIt.hasNext())
                        {
                            ...
                            aux1.remove(1);
                            List<String> aux2 = Helper
                                    .triplePartExtractor(auxtriple);
                            aux2.remove(1);
                            ...
                            else
                            {
                                ...
                                res = x.plus(HdtDataSource.getCountResults(
                                        triple, joinVariables.get(0)));
                                res2 = x.plus(HdtDataSource.getCountResults(
                                        auxtriple, joinVariables.get(0)));
                            }
...
//                                elasticStability = res.plus(res2).plus(1);
                        ...
                        else
                        {
                                    ...
                                    && ancestors.contains(aux1.get(2)))
                            {
                                ...
                                // funcion en una distancia de 0
                                Func f1 = new Func("f1",
                                        maxFreq(aux1.get(0), rprime));
                                BytecodeFunc func1 = f1.toBytecodeFunc();

                                Func f2 = new Func("f2",
                                        maxFreq(aux1.get(2), rprime));
                                BytecodeFunc func2 = f2.toBytecodeFunc();

                                mostFreqValue = Expr.valueOf(
                                        Math.min(Math.round(func1.apply(1)),
                            ...
                            if (Helper.extractor(triple, ancestors))
                            {
                                ...
                                rprime = new Join(
                                        "r" + String.valueOf(i + 1) + "prime",
                                        joinVariables,
                                        (HashSet) ancestors.clone(), rprime,
                                        triple);
                            }
                            else
                            {
                                ...
                                Func f2 = new Func("f2",
                                        elasticStability.multiply(res));
                                BytecodeFunc func2 = f2.toBytecodeFunc();

                                elasticStability = Expr.valueOf(
                                        Math.max(Math.round(func1.apply(1)),
                                                Math.round(func2.apply(1))));
